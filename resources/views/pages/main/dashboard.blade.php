...
<row> 
  <column style="background: #009688;">
    <h2 style="border-top: 3px double #000;border-bottom: 3px double #000; text-shadow: -2px 0 #000, 0 2px #000, 1px 0 #000, 0 -1px #000;box-sizing: border-box; width: 100%; background: #3f51b5; padding: 2rem; position: absolute; top:40%; left:50%;  transform: translate(-50%, -50%);">Helloo World!</h2>
  </column>
  <column>
...
<row> 
  <column>
    <div id="africa" style="width:100%;height:100%;"></div>
  </column>
  <column>
    <iframe style="width:100%;height:100%;" src="https://www.youtube.com/embed/pRpeEdMmmQ0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
  </column>
</row>